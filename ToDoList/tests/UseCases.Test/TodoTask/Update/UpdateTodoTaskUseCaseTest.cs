...
namespace UseCases.Test.TodoTask.Update;

public class UpdateTodoTaskUseCaseTest
{
    [Fact]
    ...
    private static UpdateTodoTaskUseCase CreateUseCase(
        ...
        ToDoList.Domain.Entities.TodoTask? todoTask = default)
    {
        ...
        return new UpdateTodoTaskUseCase(todoTaskRepository.Build(), unitOfWork, autoMapper, loggedUser);
    }
}